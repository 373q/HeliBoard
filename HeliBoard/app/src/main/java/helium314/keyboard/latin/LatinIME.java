...
public class LatinIME extends InputMethodService implements
        ...
        MacroManager.INSTANCE.setListener(new MacroManager.MacroListener() {
            ...
            public void onMacroSendMessage() {
                ...
                if (helium314.keyboard.compat.AppWorkarounds.INSTANCE.usesEnterForSend(pkg)) {
                    ...
                    // Instagram, Telegram, WhatsApp etc — fortat IME_ACTION_SEND direct
    ...
    void onFinishInputViewInternal(final boolean finishingInput) {
        ...
        // Macro-ul continuă să ruleze chiar dacă tastatura pierde focusul momentan —
        // se oprește DOAR la stop manual (tap space/comma).
        cleanupInternalStateForFinishInput();
    }
